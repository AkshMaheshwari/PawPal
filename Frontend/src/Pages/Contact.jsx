...
import { Mail, Phone, MapPin, PawPrint, Send, Menu, X } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-white">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl shadow-lg border-b border-yellow-100/50">
        <div className="container mx-auto flex justify-between items-center px-6 py-4">
          ...
          <button
            className="md:hidden text-gray-700 hover:text-yellow-600 transition-all duration-300"
        ...
        <motion.div
          ...
          className="md:hidden bg-white border-t border-yellow-100 shadow-inner overflow-hidden"
        >
          <div className="flex flex-col space-y-4 px-6 py-4 text-sm font-medium">
            ...
            <a
              href="/user/signup"
              onClick={() => setMenuOpen(false)}
              className="w-fit bg-gradient-to-r from-yellow-500 to-amber-500 text-white px-5 py-2 rounded-full font-semibold shadow-md hover:shadow-lg transition-all duration-300"
            >
              Get Started
            </a>
          </div>
      ...
      >
        ...
        <div className="max-w-3xl text-center mb-16">
          ...
          <p className="text-gray-600 text-base sm:text-lg md:text-xl leading-relaxed">
            Reach out to us for adoption inquiries, volunteering opportunities,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 max-w-6xl w-full">
          ...
          >
            <form
              ...
              className="bg-gradient-to-br from-white to-amber-50/30 backdrop-blur-md shadow-2xl rounded-3xl p-6 sm:p-10 space-y-8 border border-yellow-100"
            >
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-white to-yellow-50/50 backdrop-blur-md shadow-xl rounded-3xl p-8 space-y-6 border border-yellow-100 h-fit"
          >
            ...
            <div className="space-y-5 text-gray-700">
              {[ 
                ...
                { icon: Mail, title: "Email Us", value: "support@pawpal.org" },
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 leading-relaxed">
                Making pet adoption simple, safe, and successful for everyone
                involved.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-8 text-center">
            <p className="text-gray-400">
              © 2025 PawPal. All rights reserved. Made with ❤️ for animals in
              need.
            </p>
          </div>
        </div>
